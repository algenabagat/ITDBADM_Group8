...
$insert = "INSERT INTO products (product_name, price, brand_id, category_id, stock, description, is_available, date_added) 
           VALUES (?, ?, ?, ?, ?, ?, ?, NOW())";
$st = $conn->prepare($insert);
$st->bind_param("sdiiiss", $name, $price, $brand_id, $category_id, $stock, $description, $is_available);
